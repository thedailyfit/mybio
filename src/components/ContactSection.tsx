      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
              ...
              <div className="flex flex-wrap gap-3 mt-8">
                {contact.socials.map((s) => (
                  <a
                    ...
                    className="px-4 py-2 text-[10px] font-medium tracking-[0.22em] uppercase border border-[#8C6D4F]/40 text-[#C4B5A5] hover:border-[#D4AF37] hover:text-[#F7E7C4] transition-all duration-300"
                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                  >
                    {s.label} ↗
                  </a>
            ...
            {sent ? (
              <div className="py-16 text-center space-y-4">
                ...
                <p
                  ...
                  style={{ fontFamily: "'Montserrat', sans-serif" }}
                >
                  Your email client should now be open — transmission registered.
                </p>
              </div>
            ) : (
        ...
        <div className="pt-16 mt-16 border-t border-[#8C6D4F]/15 flex flex-col sm:flex-row items-center justify-between text-center sm:text-left gap-4">
          ...
          <span className="text-[10px] font-mono text-[#8C6D4F]">
            © {new Date().getFullYear()} • {profile.name.toUpperCase()} • HYDERABAD
          </span>
        </div>
      </div>
    </footer>
