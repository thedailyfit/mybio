      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "'Montserrat', sans-serif" }}
          >
            Scroll down to unfold the growth systems. Each one was built to turn attention into revenue.
          </p>
        </motion.div>
                    ...
                    <div className="space-y-3">
                      ...
                      {project.metrics.map((m) => (
                        ...
                        >
                          ...
                          <span className="text-[11px] font-mono font-medium text-[#F7E7C4]">{m.value}</span>
                        </div>
                      ))}
                    </div>
